import {Cloth} from '/webgpu/physics.js?v=22';
import {Renderer} from '/webgpu/render.js?v=29';
    ...
    <div v-if="ready && !preparing && !error && !failure" class="se-drape-controls">
      ...
      <details class="se-drape-more" @keydown.esc.prevent="$event.currentTarget.open = false">
        ...
        <div class="se-drape-menu">
          ...
          <label v-if="hasHair && show_body"><input type="checkbox" v-model="showHair" @change="appearance"> Show hair</label>
  ...
  methods: {
    async load() {
      ...
      try {
        ...
        this.hasButtons=scene.buttons?.some(b=>b.hole)||false;this.buttonsClosed=true;this.hasHair=!!scene.hair;
    ...
    appearance() {
      ...
      e.renderer.setHair(this.showHair);   // the body's hair, from the scene
