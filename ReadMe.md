...
The measurement-overview illustration
(`assets/img/measurements/overview_body_measures.svg`) is
["Body measures SVG"](https://commons.wikimedia.org/wiki/File:Body_measures_SVG.svg)
by [MagentaGreen](https://commons.wikimedia.org/wiki/User:MagentaGreen),
licensed [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/),
via Wikimedia Commons (unmodified). The per-measurement diagrams in the same
folder are generated by `generate.py` from this repository's body outline.
