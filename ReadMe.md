...
The measurement-guide diagrams (`assets/img/measurements/*.svg`) are drawn
on this repository's default mannequin by `generate.py` in that folder. The
photos of measurements being taken (`assets/img/measurements/photos/`) are by
their photographers, credited in the app and in `photos/credits.json`, used
